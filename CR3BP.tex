...
The final set of substitutions will now be made: $m_2=m-m_1$, $m_2^\star=1-m_1^\star$. Similarly, $x_2^\star=1-x_1^\star$. While $r_1^\star$ and $r_2^\star$ can be written in terms of $x_1^\star$, $x^\star$, $y^\star$, and $z^\star$, I will not do this as it makes the equations much less compact and offers no benifit in computational implimentation.
